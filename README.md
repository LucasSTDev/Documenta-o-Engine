...
Na sua primeira implementação básica é possivel que gere um erro, com isso, podendo não monstrar sua funcionalidade ou que execute apenas dando um aviso. <br/>
![image](https://github.com/LucasSTDev/Documentation-Engine/assets/116840737/82b4f27e-a8f4-4403-b8a1-8469526c5d34)
...
~~~
1. Explicação do comando:
"g++" Invoca o compilador C++ (G++). <br>
"-o game": Define o nome do executavel como "game". (O nome "game" pode ser o de sua preferência) <br>
.cpp ASCII_Engine/.cpp: São os arquivos que serão compilados. O código-fonte do programa está em um arquivo chamado .cpp e também em arquivos na pasta ASCII_Engine/. <br>
